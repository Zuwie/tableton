        ...
        <Stack spacing={8} mx={"auto"} w="100%" maxW={"lg"} py={12} px={6}>
          ...
          >
            <List spacing={4}>
              ...
              <ListItem>
                <ListIcon as={SettingsIcon} color="orange.500" /> Achievement
                system
              </ListItem>
              <ListItem>
                <ListIcon as={SettingsIcon} color="orange.500" /> Upload army
                list
              </ListItem>
              <ListItem>
                <ListIcon as={SettingsIcon} color="orange.500" /> Match history
                with score
              </ListItem>
              <ListItem>
